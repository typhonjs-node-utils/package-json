 ...
 */
declare function formatPackage(packageObj: object): PackageObjFormatted | undefined;
/**
 ...
 */
declare function getPackage(options: PackageQueryOptions): object | undefined;
/**
 ...
 */
declare function getPackageAndFormat(options: PackageQueryOptions): PackageObjFormatted | undefined;
/**
 ...
 */
declare function getPackageWithPath(options: PackageQueryOptions): PackageObjData;
/**
 ...
 */
declare function getPackageType(options: PackageQueryOptions): string;
/**
...
export { type PackageObjData, type PackageObjFormatted, type PackageQueryOptions, type TraversalCallback, type TraversalDataObj, formatPackage, getPackage, getPackageAndFormat, getPackageType, getPackageWithPath };
